...
public abstract class AbstractPlanNode implements JSONString, Comparable<AbstractPlanNode> {
    ...
    public void generateOutputSchema(Database db)
    {
        ...
        setOutputSchema(m_children.get(0).getOutputSchema().copyAndReplaceWithTVE());
    }
    ...
    */
    ...
    protected final void helpLoadFromJSONObject( JSONObject jobj, Database db ) throws JSONException {
        ...
        if ( !jobj.isNull( Members.OUTPUT_SCHEMA.name() ) ) {
            ...
            for( int i = 0; i < size; i++ ) {
                getOutputSchema().addColumn( SchemaColumn.fromJSONObject(jarray.getJSONObject(i)) );
            }
        }
    }
    ...
    public void setOutputSchema(NodeSchema m_outputSchema) {
        this.m_outputSchema = m_outputSchema;
        m_hasSignificantOutputSchema = true;
    }
}
