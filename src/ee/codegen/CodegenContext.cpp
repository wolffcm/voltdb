...
namespace voltdb {
    ...
    namespace {
        ...
        public:
            ...
            PredFnCtx(CodegenContext* codegenContext, const std::string& name)
        ...
        private:
            ...
            // functions)
            PredFnCtx(CodegenContext* codegenContext,
        ...
        class PlanNodeFnCtx {
        public:
            PlanNodeFnCtx(CodegenContext* codegenContext, AbstractExecutor* executor)
                : m_codegenContext(codegenContext)
                , m_function(NULL)
                , m_builder()
    ...
    void*
    CodegenContext::generateCode(llvm::Function* fn) {
